...
void set_up_default_scene() {
  ...
  float sphere1_transparency = 0.6;
  ...
  scene = add_sphere(scene, sphere1_ctr, sphere1_rad, sphere1_ambient,
		     ...
		     sphere1_reflectance, sphere1_transparency, sphere1_refractive_index, 1);
  ...
  scene = add_sphere(scene, sphere2_ctr, sphere2_rad, sphere2_ambient,
		     ...
		     sphere2_reflectance, sphere2_transparency, sphere2_refractive_index, 2);
  ...
  scene = add_sphere(scene, sphere3_ctr, sphere3_rad, sphere3_ambient,
		     ...
		     sphere3_reflectance, sphere3_transparency, sphere3_refractive_index, 3);
}
